...
<?php $con=mysqli_connect('localhost','root','','prosper') or die("Connection Failed:" .mysqli_connect_error()); ?>
        ...
        <nav class="navbar navbar-light navbar-expand-md navbar-fixed-top navigation-clean-button" style="background: rgb(34, 34, 34);border-radius: 20;border-top-left-radius: 20;border-top-right-radius: 20;border-bottom-right-radius: 20;border-bottom-left-radius: 20;border-style: none;padding-top: 0;padding-bottom: 10px;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navcol-1" style="justify-content: end; color: rgb(255,255,255);">
                    ...
                    <a class="btn btn-light action-button" role="button" href="login.php" style=" margin-top: 10px; color: rgba(0,0,0,0.9);background: var(--bs-gray-200);border-radius: 10px;border-style: solid;border-color: rgba(0,0,0,0.9);font-size: 16px;padding: 5px 8px;padding-right: 12px;padding-left: 12px;">Log In</a>
                <!-- </p> -->
                </div>
            </div>
        </nav>
